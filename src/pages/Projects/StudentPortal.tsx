...
const items = [
  {
    ...
    description:
      "A Student and Admin user management system with features like video upload, quiz creation, assignment submission, dynamic quiz grading, and a student leaderboard.",
  ...
  },
  {
    ...
    header: (
      <CoolModeLinks
        previewUrl="https://student-portal-w-rtk-query.netlify.app/"
        githubUrl="https://github.com/habibulmursaleen/student-portal-w-rtk-query"
      />
    ),
    className: "md:col-span-1",
