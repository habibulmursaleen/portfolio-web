...
const items = [
  {
    ...
    description: "Created with .NET Core, this API is used to manage projects and tasks for the Norsk project management application.",
  ...
  },
  {
    ...
    description: "See how the project is organized and structured in the context of Clean Architecture and Domain Driven Design principles.",
  ...
  {
    title: "Architecture",
    description: "This project is built using the principles of Clean Architecture and Domain Driven Design.",
